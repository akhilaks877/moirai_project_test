                ...
                try {
                    ...
                    foreach ($parties as $key => $partie) {
                        ...
                        //   dd($chapitre['chapitre_section2']['chapitre_section2_paragraph2_sideimg']);
                            ...
                            $html = view('Template.chapters_with_Partie_template', compact('partie', 'chapitre', 'chapitrList', 'isStartNewpartie', 'previousFile', 'nextFile', 'previouschapitreflag', 'nextchapitreFlag','assetDestination','book_entity'));
