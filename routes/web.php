...
Route::get('/{page}/{bookid}/showbook','User\EbooksController@readBook')->name('showBook');
...
Route::get('/process-webhooks-data', 'WebHookController@processWebhooksData');
Route::get('/send', [WebHookController::class, 'sendMail']);
Route::get('/send-mail', function () {
    ...
    \Mail::to('akhila@tranzmedia.com')->send(new \App\Mail\DemoMail($mailData));
