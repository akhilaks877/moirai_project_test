    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="mm-active">
                    <a href="{{ route('student.dashboard.index') }}" class="mm-active">
                ...
                <li class="app-sidebar__heading">Library Management</li>
					<li>
					<a href="{{ route('student.title.index') }}">
                    ...
                    <li>
                        <a href="{{ route('student.title.reading_book',["title" => $r_b->id]) }}">
                            <span class="metismenu-icon pe-7s-notebook"></span>
                            
                            {{ \Illuminate\Support\Str::limit(ucfirst($r_b->title), 20, $end='...') }}
					...
					<li class="app-sidebar__heading">Classes</li>
						<li>
						<a href="{{route('student.my-class')}}" class="mm-active">
						<span class="metismenu-icon pe-7s-users"></span>
						My Classes
						</a>
						</li>

                        <li class="app-sidebar__heading">Invitations</li>
                            <li>
                            <a href="{{route('student.invitation_lists')}}" class="mm-active">
                            <span class="metismenu-icon pe-7s-users"></span>
                           Teacher Invitations
                            </a>
                            </li>
