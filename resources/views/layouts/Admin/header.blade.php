                    ...
                    <div class="widget-content-wrapper">
                        <div class="widget-content-left">
                            <div class="btn-group">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route('admin.accessibility.index') }}" tabindex="0" class="dropdown-item">{{__('menus.accessibility')}}</a>
                                    <a href="{{ route('admin.my-account.index') }}" tabindex="0" class="dropdown-item">{{__('menus.myaccount')}}</a>
                        ...
                        <div class="widget-content-left  ml-3 header-user-info">
                            ...
                            <div class="widget-subheading">
                                {{ ((auth()->user()->roles)?auth()->user()->roles->first()->name:"") }}
                                {{__('menus.administrator')}}
                            </div>
                        </div>
                    </div>
                </div>
