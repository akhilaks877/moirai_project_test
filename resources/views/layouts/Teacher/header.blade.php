                        ...
                        <div class="widget-content-left">
                            <div class="btn-group">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route('teacher.accessibility.index') }}" tabindex="0" class="dropdown-item">Accessibility</a>
                                    <a href="{{ route('teacher.my-account.index') }}" tabindex="0" class="dropdown-item">My Account</a>
                                    <a href="my-badges.html" tabindex="0" class="dropdown-item">My Badges</a>
                                    <a href="faq.html" tabindex="1" class="dropdown-item">FAQ</a>
