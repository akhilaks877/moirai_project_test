...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
                ...
                <div class="col-md-12">
                    ...
                    <table class="mb-0 table table-hover">
                        ...
                        <tr>
                            ...
                            <td>John</td>
                            <td>
                                <a href="detail_teacher.html">First and last name of Teacher 1</a><br />
                                <a href="detail_teacher.html">First and last name of Teacher 2</a><br />
                            </td>
                            <td>
                                <a href="detail_student.html" class="mb-2 mr-2 border-0 btn-transition btn btn-outline-info"><span class="fa fa-pen"></span></a>
                            </td>
                        </tr>
                        <tr>
                            <td>student@student.com</td>
                            <td>Doe</td>
                            <td>John</td>
                            <td><a href="detail_teacher.html">First and last name of Teacher 1</a></td>
                            <td>
                                <a href="detail_student.html" class="mb-2 mr-2 border-0 btn-transition btn btn-outline-info"><span class="fa fa-pen"></span></a>
                            </td>
                        </tr>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="{{ route('admin.student_details.add') }}" class="btn btn-primary float-right">
