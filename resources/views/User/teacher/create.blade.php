    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <h4 class="mb-0 page-title">{{__('messages.teacher_account')}}</h4>
                    <span class="subtitle"> - {{__('messages.teacher_account_text')}}</span>
                    <div class="page-title-subheading">
                        <nav id="fil-ariane">
                            <a href="{{ route('admin.dashboard') }}">{{__('messages.home')}}</a> > <a href="{{ route('teacher_details.index') }}">{{__('messages.list_teacher')}}</a> > {{__('messages.last_first_name')}}
                        </nav>
                    </div>
                </div>
            </div>
        ...
        <div class="tab-pane tabs-animation fade show active">
            <div class="main-card mb-3 card">
                <div class="card-body"><h5 class="card-title">{{__('messages.general_information')}}</h5>
                    <form id="teacher_form" method="POST" class=""  action="{{ route('teacher_details.store') }}"  data-parsley-validate novalidate enctype="multipart/form-data">
                    @csrf
                        <div class="form-row">
                            <div class="col-md-6">
                                <p>
