        ...
        <div class="tab-pane tabs-animation fade show active">
            <div class="main-card mb-3 card">
                <div class="card-body"><h5 class="card-title">General Information</h5>
                    <form id="teacher_form" class=""  action="{{ route('teacher_details.store') }}" method="POST" data-parsley-validate novalidate>
                    @csrf
                        <div class="form-row">
                            <div class="col-md-6">
                                <p>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="position-relative form-group">
                                    <label for="language" class="">Preferred Language</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button class="mt-2 btn btn-primary float-right" type="submit">Submit</button>
                            </div>
                        </div>
                    </form>
...
$('#teacher_form').on('submit', function(event) {
        ...
        if (instance.isValid()) 
        {
            ...
            // $.ajax({
            //     url: "{{ route('teacher_details.store') }}",
            //     method: "POST",
            //     data: form_data,
            //     dataType: "json",
            //     success: function(data) {
            //         if(data.error.length>0){for(var error_html="",count=0;count<data.error.length;count++)error_html+=data.error[count],error_html+="<br>";$("#form_output").html('<div class="alert alert-danger">'+error_html+"</div>")}"success"==data.status&&($("#manage_modal").modal("hide"),location.reload(),$(".data-table").DataTable().ajax.reload());
            //     }
            // });
        }
    });
