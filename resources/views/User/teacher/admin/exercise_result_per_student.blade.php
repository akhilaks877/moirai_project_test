									...
									<form class="see_results">
										...
										<div class="row">	
											<div class="col-12">
												...
												<!-- <a href="#nogo" class="mt-2 btn btn-danger float-right">Reset Exercise</a> -->
												<button type="button" title="Reset the exercise" class="mb-2 mr-2 border-0 btn-transition btn btn-outline-info reset" data-stdid="{{$student_id}}" data-exerid="{{$exer_id}}"><span class="fa fa-history"></span> Reset Exercise</button>
											</div>
										</div>
