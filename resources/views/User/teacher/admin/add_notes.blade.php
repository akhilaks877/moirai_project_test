                        ...
                        <div class="scroll-area-sm">
                            <div class="scrollbar-container ps--active-y ps">
                                <ul class="book_index p-0">
                                    ...
                                    @else
                                    <li><a href="{{ route('teacher.title.manage_notes',['title'=>$data['book']->id,'chapter'=>$chap->id]) }}">Chapter {{$k+1}}: {{ $chap->title}}</a></li>
                                    @endif
                                   @endforeach
                                </ul>
                            </div>
                       ...
                       <div class="note_enseignant p-2 card mb-3 note col-12" style="{{ ($pref_setts->view_teacher_note != 1) ? 'display:none;':'' }}">
                        <p><strong>Your note:</strong>This note was typed by the teacher to add comments to this paragraph. It is only visible to that teacher and their students.<br /></p>
                         ...
                         <div class="collapse row">
                            <div class="col-12">
                            <form class="new_teacher_note" data-url="{{ route('teacher.title.addup_notes',['title'=> $data['book']->id]) }}">
                              <div class="main-card note-card mb-3 card"><div class="card-body"><h4 class="covrd">Teacher's Note {{$teach_key}}</h4>
                          ...
                          <div class="position-relative form-group">
                            <h5>{{__('messages.add_a_note')}}</h5>
                             @isset($teacher_text_block) <input type="hidden" name="teacher_text_block" value="{{ $teacher_text_block }}" readonly/> @endisset
                          ...
                          <div class="col-12">
                            ...
                            @isset($teacher_img_block) <input type="hidden" name="teacher_img_block" value="{{ $teacher_img_block }}" readonly/> @endisset
                            <input name="notefile[]" class="exampleFile" accept="image/*" type="file" class="form-control-file mt-2">
                            <div class="imgPreview"></div>
                            @isset($fileimg) <img src="{{ $fileimg }}" class="notes_container_img" style="width:100%"/>@endisset
                     ...
                     <!---- teacher notes ----->
                      ...
                      <div class="collapse row">
                        ...
                        <form class="new_teacher_note" data-url="{{ route('teacher.title.addup_notes',['title'=> $data['book']->id]) }}">
                          ...
                          <div class="main-card note-card mb-3 card"><div class="card-body"><h4 class="covrd">Teacher's Note {{$note_key}}</h4>
                          <input type="hidden" name="note_id" value="{{ $note_key }}" readonly/>
                      <div class="position-relative form-group">
                        <h5>{{__('messages.add_a_note')}}</h5>
                   ...
                   @endforeach
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex">
                            <a href="#" class="mt-2 ml-1 btn btn-primary mx-auto">Complete the Chapter Test</a>
                        </div>
                    </div>
                    ...
                    <div class="row ">
                        <div class="col-6 d-flex">
                            <a href="#" class="mt-2 ml-1 btn btn-primary mx-auto">&lt;&lt; Previous Chapter</a>
                        </div>
                        <div class="col-6 d-flex">
                            <a href="#" class="mt-2 ml-1 btn btn-primary mx-auto">Next Chapter &gt;&gt;</a>
                        </div>
                    </div>
                </div>
            </div>
...
$(function(){
    ...
    $('a.addup_note,a.edit_notes').on('click',function(e){
        ...
        $('form.new_teacher_note').on('submit',function(e){
