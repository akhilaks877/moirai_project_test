    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <h4 class="mb-0 page-title">Class Account: {{ (isset($model)?$model->class_name:'') }}</h4>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            ...
                            <table class="mb-0 table table-hover" data-url="{{ route('teacher.my-classes.show',['my_class'=>$model->id]) }}" id="myStudlist" style="width:100%;">
                                ...
                                {{-- <tbody>
                                <tr>
                                    <td><a href="detail_eleve.html">student@student.com</a></td>
                                    <td><a href="detail_eleve.html">John Doe</a></td>
                                    <td>21/04/2020</td>
                                    <td>Active</td>
                                    <td>
                                        ...
                                        <a href="#nogo" class="mb-2 mr-2 border-0 btn-transition btn btn-outline-info"><span class="fa fa-times-circle pr-2"></span> Remove Student from Class</a>
                                    </td>
                                </tr>
                                <tr class="inactive">
                                    <td><a href="detail_eleve.html" class="disabled">student@student.com</a></td>
                                    <td><a href="detail_eleve.html" class="disabled">John Doe</a></td>
                                    <td>21/04/2020</td>
                                    <td>Invitation Sent</td>
                                    <td>
                                        <a href="detail_student.html" class="mb-2 mr-2 border-0 btn-transition btn btn-outline-info disabled"><span class="fa fa-eye pr-2"></span> See Student Activity</a>
                                        <a href="#nogo" class="mb-2 mr-2 border-0 btn-transition btn btn-outline-info"><span class="fa fa-times-circle pr-2"></span> Remove Student from Class</a>
                                    </td>
                                </tr>
                                </tbody> --}}
...
$(function(){
    ...
    var table=$("#myStudlist").DataTable({
        processing: true,
        serverSide: true,
        ajax: {
         url: $(this).data('url'),
