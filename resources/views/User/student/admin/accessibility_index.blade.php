         ...
         <div class="page-title-heading">
            ...
            <div>
               ...
               <div class="page-title-subheading">
                  <nav id="fil-ariane">
                     <a href="{{ route('student.dashboard.index') }}">{{__('messages.home')}}</a> >
   ...
   <div class="tab-content">
						<div class="tab-pane tabs-animation fade show active">
							<div class="main-card mb-3 card">
								<div class="card-body">
									<h5 class="card-title">{{__('messages.my_accessibility_settings')}}</h5>
									<form class="" action="" method="POST"  data-url="" id="preffsett" data-parsley-validate>
                                       ...
                                       @method('PATCH')
                                        <div class="row">
											...
											<div class="col-12">
                                               <input type="checkbox" id="active_notification" name="show_notification" value="{{ ($pref_setts->show_notification == 1)?1:2 }}" @if($pref_setts->show_notification == 1) checked @endif data-toggle="toggle" data-size="small" data-onstyle="success" data-offstyle="primary" >
												<label class="form-check-label pl-2" for="active_notification">{{__('messages.enable_notifications')}}</label>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-12">
												<hr>
												<h6>{{__('messages.font_preferences')}}</h6>
											</div>
											<div class="col-md-6">
												<div class="position-relative form-group text-center">
													<p>{{__('messages.decrease_font_size')}}</p>
													<a href="javascript:void(0);" class="decFont manip mt-2 btn btn-primary">A <sup>-</sup></a>
												</div>
											</div>
											<div class="col-md-6">
												<div class="position-relative form-group text-center">
													<p>{{__('messages.increase_font_size')}}</p>
                                            ...
                                            <div class="col-12">
												<h6 class="fontsize_chosen">{{__('messages.selected_font_size')}} : <strong>{{ $pref_setts->selected_font_size }}</strong></h6>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-12">
												<hr>
												<h6>{{__('messages.menu_preferences')}}</h6>
											</div>
											<div class="col-md-6">
