                        ...
                        <div class="scroll-area-sm">
                            <div class="scrollbar-container ps--active-y ps">
                                <ul class="book_index p-0">
                                    ...
                                    @else
                                    <li><a href="{{ route('student.title.reading_book',['title'=>$data['book']->id,'chapter'=>$chap->id]) }}">Chapter {{$k+1}}: {{ $chap->title}}</a></li>
                                    @endif
                                   @endforeach
                                </ul>
                            </div>
                   ...
                   @endforeach
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex">
                            <a href="{{ route('student.title.show_exercises_types',['chapter'=>$data['chapter_data']->id])}}" class="mt-2 ml-1 btn btn-primary mx-auto">Complete the Chapter Test</a>
...
$(function(){
    ...
    $(document).on('change','.note_sett',function(){
           ...
           $currURL="{{ route('student.title.reading_book',['title'=>$data['book']->id]) }}"; 
