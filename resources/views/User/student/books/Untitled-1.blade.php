            ...
            <div class="tab-pane tabs-animation fade show active">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        {!! $block->content !!}
                        <a data-toggle="collapse" href="#collapse_note1" class="btn-open-options btn btn-primary float-right add_note" aria-expanded="false"><span class="fa fa-plus fa-w-16"></span> Add a note</a>
...
<script>
    ...
    $(function(){
        ...
        $(document).on('change','.note_sett',function(){
               ...
               var currURL="{{ route('student.book-reading',['id'=>$data['book']->id]) }}"; 
                //console.log(currURL);
