        ...
        try {
          ...
          foreach ($parties as $key => $partie) {
            ...
            foreach ($partie['chapitres'] as $key => $chapitre) {
              ...
              //echo "<pre>".print_r($arrayNew);exit;
              $stringHTML='';

              $tabletype = 0;
              $stringHTML="<style>table, th, td {
              ...
              foreach($arrayNew as  $key => $value){
                ...
                if(!(str_contains($stringkey, 'table'))){
                  if($tabletype == 1){
                    $stringHTML .= "</tr></table>";
                  }
                  $tabletype = 0;
                ...
                //        if(!(str_contains($stringkey, 'entete.0'))){
                //     if($tabletype == 1){
                //         $stringHTML .= "</tr></thead></table>";
                //     }
                //
                //     $tabletype = 0;
                // }

                // if(str_contains($stringkey , 'chapitre_title')){
                //
                //
                //   $stringHTML .= '<h1>'.$value.'</h1>';
                // }
                //
                // if(str_contains($stringkey, '_paragraph_table__title')){
                //
                //
                ...
                // if(str_contains($stringkey, 'entete')){
                //
                //
                //   if(str_contains($key, 'entete.0')){
                //
                //     $stringHTML .= '<th>'.$value.'</th>';
                //   }
                //   else{
                //     $stringHTML .= '<th>'.$value.'</th>';
                //   }
                ...
                // if(str_contains($stringkey, 'line')){
                //
                //
                //   if(substr($key, -1) == '0'){
                //
                //
                //     $stringHTML .= '<br><td>'.$value.'</td>';
                //   }else{
                ...
                // }
                //
                // if(str_contains($stringkey ,'chapitre.chapitre_section.chapitre_section_intro')){
                //
                //
                //   $stringHTML .= '<h6>'.$value.'</h6>';
                // }

            if(str_contains($key ,'chapitre_section_intro')){
                $stringHTML .= '<div class="row mt-4 mise-en-situation">
                      <div class="col-md-12">
                          <div style="background:">';
                        }
                          if(str_contains($key ,'chapitre_situation')){
                                $stringHTML .= '<div class="row px-4 py-5">
                                  <div class="col-12">
                  ...
                  if(str_contains($key ,'chapitre_txtintro')){

                    $stringHTML .= '<div class="row chapter_content px-4 py-5">
                      <div class="col-12">
                          <p>'.$value.'</p>';
                        }
                          // if(str_contains($stringkey ,'@attributes')){
                          //   $stringHTML .= '<figure class="figure img-insert-txt col-12 col-md-6 col-lg-5">
                          //     <img class="img-fluid" alt="" title="" src="'.$value.'">';
                          //   }
                                if(str_contains($stringkey ,'chapitre_imgintro_legende')){
                              $stringHTML .= '<figcaption class="text-right">'.$value.'</figcaption>
                          </figure></div>';
                    }
                    if(str_contains($stringkey ,'chapitre_section_title')){

                      $stringHTML .= '<div class="col-12 chapitre_section">
                          <span class="section_number" style="background-color:">1.1</span>
                          <h5 class="section_title">'.$value.'</h5>';
                        }
                          if(str_contains($stringkey ,'chapitre_section_intro')){
                          $stringHTML .= '<p class="section_intro">'.$value.'</p>';
                        }
                          if(str_contains($stringkey ,'chapitre_section_paragraph_title')){

                          $stringHTML .= '<h6 class="paragraph_title"><span style=""
                                  class="number">1.1.1</span> '.$value.'</h6>';
                                }
                                  if(str_contains($stringkey ,'chapitre_section_paragraph_intro')){
                            $stringHTML .= '<p class="paragraph_intro">'.$value.'</p>';
                          }
                            if(str_contains($stringkey ,'chapitre_section_paragraph_subtitle_')){
                        $stringHTML .= '<h6 class="paragraph_subtitle">
                              <span style="background-color:" class="puce"></span>
                              '.$value.'</h6>';
                            }
                              if(str_contains($stringkey ,'chapitre_section_paragraph_txt_')){
                            $stringHTML .= '<p class="paragraph_txt">'.$value.'</p>';
                          }
                            if(str_contains($stringkey ,'chapitre_section_paragraph_txt_rappel')){

                            $stringHTML .= '<div class="rappel p-4">
                              <strong>Rappel</strong><br />'.$value.'</div>';
                            }
                              if(str_contains($stringkey ,'chapitre_section_paragraph_subtitle_')){

                          $stringHTML .= '<h6 class="paragraph_subtitle"><span style=""
                                  class="puce"></span>'.$value.'</h6>';
                                }
                                  if(str_contains($stringkey ,'chapitre_section_paragraph_txt_')){
                            $stringHTML .= '<p class="paragraph_txt">'.$value.'</p>';
                          }
                            ...
                            $stringHTML .= '<h6 class="paragraph_title"><span style=""
                                  class="number">1.1.2</span>'.$value.'</h6>';
                                }
                                  if(str_contains($stringkey ,'chapitre_section_paragraph_intro')){

                            $stringHTML .= '<p class="paragraph_intro">'.$value.'</p>';
                          }
                            if(str_contains($stringkey ,'chapitre_section1_paragraph3_title')){

                          $stringHTML .= '<h6 class="paragraph_title"><span style=""
                                  class="number">1.1.3</span>'.$value.'</h6>';
                                }
                                  if(str_contains($stringkey ,'chapitre_section_paragraph_subtitle_')){
                            ...
                            $stringHTML .= '<h6 class="paragraph_subtitle"><span style=""
                                  class="puce"></span>'.$value.'</h6>';
                                    ...
                                    if(str_contains($stringkey ,'chapitre_section_paragraph_sideimg_legend')){
                          ...
                          $stringHTML .= '<figure class="figure img-insert-txt col-12 col-md-6 col-lg-5">
                              ...
                              <figcaption class="text-right">'.$value.'</figcaption>
                          </figure>';
                        }
                          if(str_contains($stringkey ,'chapitre_section_paragraph_txt_')){
                          ...
                          $stringHTML .= '<h6 class="paragraph_subtitle"><span style="background-color:"
                                  class="puce"></span>'.$value.'</h6>';
                                }

                            if(str_contains($stringkey ,'chapitre_section_paragraph_ensavoirplus_')){


                          $stringHTML .= '<p class="en-savoir-plus ml-sm-5 ml-1 p-5">
                              <strong style="color:">En savoir plus...</strong><br /><br />
                              '.$value.'</p>';
                            }


                          if(str_contains($stringkey ,'chapitre_section_paragraph_citation_')){

                          $stringHTML .= '<blockquote class="blockquote">'.$value.'</blockquote>';
                        }
                          if(str_contains($stringkey ,'chapitre_section_paragraph_remarque_')){



                            $stringHTML .= '<div class="remarque p-3">
