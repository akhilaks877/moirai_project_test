                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class=" pb-4 table_of_content">
                      ...
                      The colors also come from the XML with the field : -->
                                ...
                                <img class="img-fluid" src="{{asset('assets/book/transp_for_size.png')}}" />
                        ...
                        <div class="row chapter_nav">
                            <div class="col-6 d-flex">
                                <a href="{{route('showBook',["page" => $introductionFile, "bookid" => $book_entity])}}" class="mt-2 ml-1 btn btn-primary mx-auto">&lt;&lt;
                                    Introduction</a>
                            </div>
                            <div class="col-6 d-flex">
                                <a href="{{route('showBook',["page" => $chapitre1, "bookid" => $book_entity])}}" class="mt-2 ml-1 btn btn-primary mx-auto">Chapter 1
                                    &gt;&gt;</a>
                            </div>
                        </div>
                    </div>
