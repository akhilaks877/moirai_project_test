                            ...
                            <div class="col-md-12">
                                <div style="background: {!! $chapitre['chapitre_colour']['@attributes']['color'] !!};">
                                    <div class="row chapter_title_container d-flex">
                                        ...
                                        <div class="col-12 col-md-6"> <img src="./assets/book/chapter_image.png" alt=""
                        ...
                        <div class="row chapter_content px-4 py-5">
                            <div class="col-12">
                                ...
                                <figure class="figure img-insert-txt col-12 col-md-6 col-lg-5">
                                    <img class="img-fluid" alt="" title="" src="http://placekitten.com/g/600/400">
                            ...
                            <div class="col-12 chapitre_section">
                                ...
                                <figure class="figure img-insert-txt col-12 col-md-6 col-lg-5">
                                    <img class="img-fluid" alt="" title="" src="http://placekitten.com/600/400">
                            ...
                            <div class="col-12 chapitre_section">
                                ...
                                <figure class="text-center">
                                    <img class="img-fluid" alt="" title="" src="http://placekitten.com/900/400">
                                ...
                                <div class="table-responsive">
                                    <strong>{!! $chapitre['chapitre_section2']['chapitre_section2_paragraph2_table_1']['chapitre_section2_paragraph2_table_1_title'] !!}</strong>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                @foreach ($chapitre['chapitre_section2']['chapitre_section2_paragraph2_table_1']['thead']['chapitre_section2_paragraph2_table_1_entete'] as $item)
                                                    <th scope="col">{!! $item !!}</th>
                                                @endforeach
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($chapitre['chapitre_section2']['chapitre_section2_paragraph2_table_1']['tbody'] as $row)
                                                <tr>
                                                    @foreach ($row as $item)
                                                        <td>{!! $item !!}</td>
                                                    @endforeach
                                ...
                                <div class="figure_with_title col-12 col-sm-6 col-md-6 col-lg-5">
                                    ...
                                    <figure>
                                        <img class="img-fluid" alt="" title="" src="http://placekitten.com/500/500">
