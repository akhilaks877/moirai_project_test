	...
	<div class="parent_header_reading">
		<div class="header_reading">
			<div class="row navbar_uncollapsed_desktop">
				<div class="col-md-9">
					<h1 class="ml-2 mt-2 title_chapter_nav">Iconographie</h1>
				</div>
				<div class="col-md-3">
				...
				<div class=" pb-4 table_of_content">
					<div class="row">
						<div class="col-md-12 px-4">
							...
							<h2 class="standard_main_title">Iconographie</h2>
							<img class="img-fluid" src="assets/book/transp_for_size.png" />
						</div>	
					</div>

					<div class="row">
						@foreach ($data['icono'] as $item)
						<div class="col-sm-6 col-lg-4 px-4 biblio_reference">
							<strong>{!! $item['icono_titre'] !!}</strong>
							<p class="px-4">{!! $item['icono_txt'] !!}</p>
						</div>
						@endforeach
					</div>
					...
					<div class="row chapter_nav">
						<div class="col-6 d-flex">
							<a href="{{route('showBook',["page" => $bibliography, "bookid" => $book_entity])}}" class="mt-2 ml-1 btn btn-primary mx-auto">&lt;&lt; Bibliographie</a>
						</div>
						<div class="col-6 d-flex">
						</div>
					</div>
