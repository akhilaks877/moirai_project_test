        ...
        try {
          ...
          foreach ($parties as $key => $partie) {
            ...
            foreach($arrayNew as  $key => $value){
              ...
              if(str_contains($stringkey ,'chapitre_fairelepoint_title')){
              ...
              if(str_contains($stringkey ,'chapitre_situation')){
              ...
              if(str_contains($stringkey ,'chapitre_section.chapitre_section_paragraph_txt_')){
