                    ...
                    <div class="card-body introduction">
                        ...
                        <div class="row moirai_data">
                            <div class="col-md-3 d-flex align-items-center">
                                <img src="{{asset('assets/images/logo-inverse.png')}}" alt="logo-inverse.png" class="img-fluid" />
                            </div>
                            <div class="col-md-3 d-flex align-items-center">
                        ...
                        <div class="row chapter_nav">
                            ...
                            <div class="col-6 d-flex">
                                <a href="{{route('showBook',["page" => $tbl_of_cnt_File, "bookid" => $book_entity])}}" class="mt-2 ml-1 btn btn-primary mx-auto">Table des
                                    matières</a>
                            </div>
                        </div>
                    </div>
