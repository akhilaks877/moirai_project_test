                    ...
                    <div class="chapter pb-4">
                        ...
                        <div class="row chapter_content px-4 py-5">
                            ...
                            <div class="col-12 chapitre_section">
                                ...
                                @foreach($chapitre['chapitre_section2']['chapitre_section2_paragraph2_table_1'] as $table)
                                <div class="table-responsive">
                                    <strong>{!! $table['chapitre_section2_paragraph2_table_1_title'] !!}</strong>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                @foreach ($table['thead']['chapitre_section2_paragraph2_table_1_entete'] as $item)
